...
function fetchlogin(evt) {
    ...
    fetch('http://localhost:80/2021/proj-template-docker-main/api/api.php?action=login', 
    {
        method: 'POST',
        body: fd,
        credentials: 'include'
...
function fetchregister(evt) {
    ...
    fetch('http://localhost:80/2021/proj-template-docker-main/api/api.php?action=register', 
    {
        method: 'POST',
        body: fd,
        credentials: 'include'
...
function fetchaccountexists(evt) {
    ...
    fetch('http://localhost:80/2021/proj-template-docker-main/api/api.php?action=accountexists&username='+ evt.srcElement.value, 
        {
            method: 'GET',
            credentials: 'include'
        })
...
function fetchisloggedin(evt) {
    fetch('http://localhost:80/2021/proj-template-docker-main/api/api.php?action=isloggedin', 
    {
        method: 'GET',
        credentials: 'include'
    })
...
function fetchlogout(evt) {
    fetch('http://localhost:80/2021/proj-template-docker-main/api/api.php?action=logout', 
    {
        method: 'GET',
        credentials: 'include'
    })
